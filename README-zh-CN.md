...
PixPill 像素胶囊 是一颗比真实胶囊大不了多少的小玩意。在四层 HDI 微型 PCB 上，塞进了一颗 STM32C011 主控、一颗 BMA530 加速度计、一颗 IS31FL3736 LED 矩阵驱动芯片、96 颗 0201 微型 LED，以及一颗 nPM1100 电源管理芯片。固件跑的是一套基于物理的粒子模拟——倾斜它，沙子会倾泻、液体会流动。
...
| **PCB** | 四层一阶 HDI | 8.6x23.9 mm / 6.9x19.5mm |
